...
_CSS = """
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body::before { content: ''; position: fixed; inset: 0; background-image: radial-gradient(1px 1px at 8% 12%, rgba(255,255,255,.9) 0%, transparent 100%), radial-gradient(1px 1px at 22% 38%, rgba(255,255,255,.6) 0%, transparent 100%), radial-gradient(1px 1px at 38% 7%, rgba(255,255,255,.8) 0%, transparent 100%), radial-gradient(1px 1px at 52% 62%, rgba(255,255,255,.5) 0%, transparent 100%), radial-gradient(1px 1px at 67% 22%, rgba(255,255,255,.9) 0%, transparent 100%), radial-gradient(1px 1px at 83% 78%, rgba(255,255,255,.7) 0%, transparent 100%), radial-gradient(1px 1px at 14% 83%, rgba(255,255,255,.5) 0%, transparent 100%), radial-gradient(1px 1px at 91% 9%, rgba(255,255,255,.8) 0%, transparent 100%), radial-gradient(1px 1px at 61% 91%, rgba(255,255,255,.6) 0%, transparent 100%), radial-gradient(1px 1px at 33% 54%, rgba(255,255,255,.4) 0%, transparent 100%), radial-gradient(2px 2px at 76% 44%, rgba(167,139,250,.7) 0%, transparent 100%), radial-gradient(2px 2px at 18% 68%, rgba(139,92,246,.6) 0%, transparent 100%), radial-gradient(1px 1px at 47% 33%, rgba(255,255,255,.9) 0%, transparent 100%), radial-gradient(1px 1px at 95% 55%, rgba(255,255,255,.5) 0%, transparent 100%), radial-gradient(1px 1px at 4% 28%, rgba(255,255,255,.7) 0%, transparent 100%), radial-gradient(1px 1px at 72% 15%, rgba(255,255,255,.6) 0%, transparent 100%), radial-gradient(1px 1px at 29% 72%, rgba(255,255,255,.8) 0%, transparent 100%), radial-gradient(2px 2px at 58% 48%, rgba(196,181,253,.5) 0%, transparent 100%), radial-gradient(1px 1px at 87% 32%, rgba(255,255,255,.7) 0%, transparent 100%), radial-gradient(1px 1px at 43% 88%, rgba(255,255,255,.4) 0%, transparent 100%); pointer-events: none; z-index: 0; }
    body > * { position: relative; z-index: 1; }
    header { background: linear-gradient(135deg, #0c0c28 0%, #111138 60%, #0a1530 100%); color: white; padding: 28px 32px; box-shadow: 0 2px 24px rgba(99,102,241,.2); border-bottom: 1px solid rgba(99,102,241,.18); }
    header h1 { font-size: 1.8rem; font-weight: 700; }
    header p { font-size: 0.83rem; color: #7986b8; margin-top: 6px; }
    ...
    .article-card { display: block; background: rgba(13,13,40,.9); border-radius: 10px; padding: 16px 18px; text-decoration: none; color: inherit; border: 1px solid rgba(99,102,241,.12); box-shadow: 0 1px 6px rgba(0,0,0,.4); transition: all .18s; }
    .article-card:hover { transform: translateY(-2px); box-shadow: 0 6px 24px rgba(99,102,241,.2), 0 0 0 1px rgba(139,92,246,.3); border-color: rgba(139,92,246,.35); }
    .article-title { font-size: 0.88rem; font-weight: 600; line-height: 1.55; color: #dde4f5; margin-bottom: 10px; }
    .article-meta { font-size: 0.76rem; color: #818cf8; font-weight: 500; }
    .empty-msg { text-align: center; color: #3d4470; padding: 60px 0; font-size: 0.95rem; }
